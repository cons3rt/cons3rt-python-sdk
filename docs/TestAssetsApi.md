# cons3rt.TestAssetsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_test_asset_trusted_project**](TestAssetsApi.md#add_test_asset_trusted_project) | **PUT** /api/testassets/{id}/addtrustedproject | 
[**add_trusted_project**](TestAssetsApi.md#add_trusted_project) | **PUT** /api/assets/{id}/addtrustedproject | Assign Trusted Project to Asset
[**delete_asset**](TestAssetsApi.md#delete_asset) | **DELETE** /api/assets/{id} | Delete asset
[**download**](TestAssetsApi.md#download) | **GET** /api/assets/{id}/download | Download Asset
[**download_file_from_bucket**](TestAssetsApi.md#download_file_from_bucket) | **GET** /api/clouds/{id}/buckets/{bucket_id}/download | Download File From Bucket
[**get_test_asset**](TestAssetsApi.md#get_test_asset) | **GET** /api/testassets/{id} | Retrieve Test Asset
[**get_test_assets**](TestAssetsApi.md#get_test_assets) | **GET** /api/testassets | List Test Assets
[**get_test_assets_expanded**](TestAssetsApi.md#get_test_assets_expanded) | **GET** /api/testassets/expanded | List all Test Assets, including Project Assets
[**itar_restrict_asset**](TestAssetsApi.md#itar_restrict_asset) | **PUT** /api/assets/{id}/setitar | Set Asset Export Restriction
[**list_dependent_assets**](TestAssetsApi.md#list_dependent_assets) | **GET** /api/assets/{id}/dependent | List all Dependent Assets
[**remove_trusted_project**](TestAssetsApi.md#remove_trusted_project) | **PUT** /api/assets/{id}/removetrustedproject | Unassign Trusted Project from Asset
[**update_asset**](TestAssetsApi.md#update_asset) | **PUT** /api/assets/{id}/update | Update Asset
[**update_asset_content**](TestAssetsApi.md#update_asset_content) | **PUT** /api/assets/{id}/updatecontent | Update Asset Content
[**update_asset_state**](TestAssetsApi.md#update_asset_state) | **PUT** /api/assets/{id}/updatestate | Update State
[**update_asset_visibility_query**](TestAssetsApi.md#update_asset_visibility_query) | **PUT** /api/assets/{id}/updatevisibility | Update Visibility
[**update_impact_level**](TestAssetsApi.md#update_impact_level) | **PUT** /api/assets/{id}/impactlevel | Update Impact Level
[**update_instance_limit**](TestAssetsApi.md#update_instance_limit) | **PUT** /api/assets/{id}/limit | Update Instance Limit
[**update_offline_status**](TestAssetsApi.md#update_offline_status) | **PUT** /api/assets/{id}/offline | Update Offline Status


# **add_test_asset_trusted_project**
> str add_test_asset_trusted_project(id, trustedid)
...
trustedid = 'trustedid_example' # str | 
    ...
    try:
        api_response = api_instance.add_test_asset_trusted_project(id, trustedid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TestAssetsApi->add_test_asset_trusted_project: %s\n" % e)
```
...
trustedid = 'trustedid_example' # str | ID of project to trust
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->add_trusted_project: %s\n" % e)
```
...
force = False # bool | Allow delete if there are dependent assets (optional) (default to False)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->delete_asset: %s\n" % e)
```
...
background = False # bool | Force the download to happen in the background (optional) (default to False)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->download: %s\n" % e)
```
...
background = False # bool | Force the download to happen in the background (optional) (default to False)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->download_file_from_bucket: %s\n" % e)
```
...
with cons3rt.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cons3rt.TestAssetsApi(api_client)
    id = 'id_example' # str | ID of test asset
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->get_test_asset: %s\n" % e)
```
...
with cons3rt.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cons3rt.TestAssetsApi(api_client)
    type = 'type_example' # str | Test Asset type (optional)
...
page = 0 # int | Requested page number (optional) (default to 0)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->get_test_assets: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **type** | **str**| Test Asset type | [optional] 
...
page = 0 # int | Requested page number (optional) (default to 0)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->get_test_assets_expanded: %s\n" % e)
```
...
with cons3rt.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->itar_restrict_asset: %s\n" % e)
```
...
with cons3rt.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->list_dependent_assets: %s\n" % e)
```
...
trustedid = 'trustedid_example' # str | ID of project to untrust
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->remove_trusted_project: %s\n" % e)
```
...
input_asset_for_update = cons3rt.InputAssetForUpdate() # InputAssetForUpdate | The modified Asset metadata (optional)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_asset: %s\n" % e)
```
...
filename = 'filename_example' # str |  (optional)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_asset_content: %s\n" % e)
```
...
state = 'state_example' # str | The new asset state type
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_asset_state: %s\n" % e)
```
...
visibility = 'visibility_example' # str | The new asset visibility type
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_asset_visibility_query: %s\n" % e)
```
...
impactlevel = 'impactlevel_example' # str | The new asset impact level type.
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_impact_level: %s\n" % e)
```
...
limit = 56 # int | The new asset instance limit
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_instance_limit: %s\n" % e)
```
...
offline = True # bool | Set the asset status to offline (optional) (default to True)
    ...
    try:
        ...
        print("Exception when calling TestAssetsApi->update_offline_status: %s\n" % e)
```
