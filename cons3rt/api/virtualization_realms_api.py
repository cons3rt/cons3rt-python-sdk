...
class VirtualizationRealmsApi(object):
    ...
    def redeploy_edges(self, id, **kwargs):  # noqa: E501
        """Re-deploy Network Edge Devices  # noqa: E501

        Re-deploys the Network Edge Device(s) in the specified Virtualization Realm.<br> <br> Note: This option is only available in VCloud Virtualization Realms.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.redeploy_edges(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.redeploy_edges_with_http_info(id, **kwargs)  # noqa: E501

    def redeploy_edges_with_http_info(self, id, **kwargs):  # noqa: E501
        """Re-deploy Network Edge Devices  # noqa: E501

        Re-deploys the Network Edge Device(s) in the specified Virtualization Realm.<br> <br> Note: This option is only available in VCloud Virtualization Realms.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.redeploy_edges_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `redeploy_edges`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/virtualizationrealms/{id}/networks/redeployedges', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
